...
_PROJECT_NAME: str = "Pandas Car Insights"
_PROJECT_VERSION: str = "0.1.0"
_PROJECT_AUTHOR: str = "Cauê Oliveira"
_PROJECT_DESCRIPTION: str = (
    "Data analysis project with Pandas that cleans car data, organizes it, "
    "and produces insights like average MPG per brand."
)
